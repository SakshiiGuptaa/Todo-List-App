    ...
    <>
      <Navbar/>
        <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[40%]">
          <h1 className='font-bold text-center text-[27px]'>iTask - Manage your todos at one place</h1>
          ...
          <input className="my-4" onChange={toggleFinished} type="checkbox" checked={showFinished} id="" /> <label className="mx-2" htmlFor="show">Show Finished</label>
          ...
          <div className="todos ">
            ...
            {todos.map(item=>{
              ...
              return (showFinished || !item.isCompleted) && <div key={item.id} className="todo flex my-3 justify-between">
                ...
                <div className="buttons flex my-auto h-full">
